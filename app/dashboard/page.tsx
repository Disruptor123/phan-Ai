                  ...
                  {seiIntegration && (
                    <div className="bg-blue-900/20 border border-blue-700 rounded-lg p-4">
                      <p className="text-blue-300 text-sm">
                        Sei integration will provide enhanced security features, optimized smart contract execution, and
                        seamless token management capabilities.
                      </p>
                    </div>
                  )}
                </div>
          ...
          <TabsContent value="deployment" className="space-y-6">
            ...
            <Card className="bg-black border-gray-800">
              ...
              <CardContent className="space-y-6">
                ...
                <Button onClick={handleUpdateTokenConfig} className="w-full bg-blue-600 hover:bg-blue-700 text-white">
