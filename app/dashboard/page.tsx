...
export default function Dashboard() {
  ...
  // Add state for first-time user experience
                        ...
                        {seiIntegration && (
                          <div className="bg-blue-900/20 border border-blue-700 rounded-lg p-4">
                            <p className="text-blue-300 text-sm">
                              Sei integration will provide enhanced security features, optimized smart contract
                              execution, and seamless token management capabilities.
                            </p>
                          </div>
                        )}
                      </div>
                    ...
                    <CardContent>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="bg-black border border-gray-700 rounded p-3 text-sm">
                          <div className="text-gray-400">• No blockchain deployed yet</div>
                          <div className="text-gray-400">• Create your first phantom blockchain to see analytics</div>
                          <div className="text-gray-400">• Performance metrics will appear after deployment</div>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                        ...
                        {operationSignatures.token_creation && (
                          <div className="bg-green-900/20 border border-green-700 rounded-lg p-3 mb-4">
                            <div className="flex items-center space-x-2">
                              <CheckCircle className="w-4 h-4 text-green-400" />
                              <span className="text-green-300 text-sm">
                                Token creation verified with signature:{" "}
                                {operationSignatures.token_creation.slice(0, 10)}
                                ...
                              </span>
                            </div>
                          </div>
